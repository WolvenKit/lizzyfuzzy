import { AuditLogEvent, EmbedBuilder, GuildAuditLogs, GuildAuditLogsEntry, TextChannel, ThreadChannel, User } from 'discord.js'
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields(
                    ...
                    },
                    {
                        ...
                        value: `${thread.type === 12 ? ':no_entry_sign: Is Private' : ':ballot_box_with_check: Is Public'}`,
                        inline: true,
                    },
                    {
                        name: '\u200b',
