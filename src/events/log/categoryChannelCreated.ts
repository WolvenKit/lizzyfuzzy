import { EmbedBuilder, TextChannel, AuditLogEvent, GuildAuditLogs, GuildAuditLogsEntry, User, CategoryChannel } from 'discord.js'
...
export default event('channelCreate', async ({ log, client }, channel) => {
    ...
    try {
        ...
        const embed = new EmbedBuilder()
            .setTitle(':green_circle: Category Created')
            .setColor(0x2b2d31)
            .addFields(
                {
