import { AuditLogEvent, EmbedBuilder, GuildAuditLogs, GuildAuditLogsEntry, GuildMember, TextChannel, User } from 'discord.js'
...
export default event('guildMemberRemove', async ({ log, client }, Member) => {
    ...
    try {
        ...
        const logChannel = client.channels.cache.get(process.env.JOINLEAVE_CHANNEL_ID) as TextChannel
